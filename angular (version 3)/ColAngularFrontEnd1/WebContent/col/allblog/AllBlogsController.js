app.controller("AllBlogsController",function($scope,$http,$rootScope,$route)	
					...
					console.log("username in allblog controller:"+$rootScope.uname);
							 $http.get("http://localhost:8086/angularbackend/viewAllBlogs")
							 ...
							 { 
						       ...
						       var like=
								...
								console.log("postedby:"+$rootScope.uname);
								 $http.put('http://localhost:8086/angularbackend/updateBlog',like);
								 $http.get("http://localhost:8086/angularbackend/viewBlogs")
								    .then(function (response) {
					 ...
					 $http.get("http://localhost:8086/angularbackend/viewComments/"+$scope.viewcomments.blog_id)
								    .then(function (response) {
						...
						$scope.comment=function(allblogs)
						{
							...
							$http.post('http://localhost:8086/angularbackend/addComment',comment);
						 $http.get("http://localhost:8086/angularbackend/viewAllBlogs")
							    .then(function (response) {
