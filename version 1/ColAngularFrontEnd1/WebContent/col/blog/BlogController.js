...
app.controller("BlogController",function($scope,$http,$rootScope)	
					...
					$http.get("http://localhost:8086/angularbackend/viewMyBlogs/"+$rootScope.uname)
							 ...
							 $scope.newBlog={};
								...
								$scope.addBlog=function(newBlog)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8086/angularbackend/addBlog',dataObj);
									 $http.get("http://localhost:8086/angularbackend/viewMyBlogs/"+$rootScope.uname)
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:8086/angularbackend/updateBlog",edit);
					$http.get("http://localhost:8086/angularbackend/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				$http.post("http://localhost:8086/angularbackend/deleteBlog",del);
					$http.get("http://localhost:8086/angularbackend/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
