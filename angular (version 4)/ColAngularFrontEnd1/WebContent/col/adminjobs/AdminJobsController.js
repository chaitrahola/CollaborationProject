app.controller("AdminJobsController",function($scope,$http,$rootScope)	
							 ...
							 $scope.newJobs={};
								...
								$scope.addJobs=function(newJobs)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8086/angularbackend/addJobs',dataObj);
									 $http.get("http://localhost:8086/angularbackend/viewJobs")
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:8086/angularbackend/updateJob",edit);
					 $http.get("http://localhost:8086/angularbackend/viewJobs")
					    .then(function (response) {
				...
				$http.post("http://localhost:8086/angularbackend/deleteJob",del);
					 $http.get("http://localhost:8086/angularbackend/viewJobs")
					    .then(function (response) {
